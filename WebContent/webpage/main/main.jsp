...
<!-- 顶部-->
<div region="north" border="false" title="新疆网络安全预警平台" style="BACKGROUND: #E6E6FA; height: 85px; padding: 1px; overflow: hidden;">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td align="left" style="vertical-align: text-bottom;"><img src="plug-in/login/images/foot.png"> <img src="plug-in/login/images/head.png;"></td>
