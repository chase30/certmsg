...
<body>
    ...
    <div id="login">
        ...
        <div class="inner">
            <div class="logo"><img src="plug-in/login/images/foot.png" /><img src="plug-in/login/images/head.png" /></div>
            ...
            <div class="formLogin">
                <form name="formLogin" id="formLogin" action="loginController.do?login" check="loginController.do?checkuser" method="post">
                    ...
                    <div class="tip">
                        <input class="userName" name="userName" type="text" id="userName" title="用户名" iscookie="true" value="xjwlaq" nullmsg="请输入用户名!" />
                    </div>
                    <div class="tip">
    ...
    <div class="clear"></div>
    <div id="versionBar">
        <div class="copyright">推荐使用IE8+,谷歌浏览器可以获得更快,更安全的页面响应速度</div>
    </div>
    <!-- Link JScript-->
