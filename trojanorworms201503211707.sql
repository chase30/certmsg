...
Source Database       : trojanorworms

Target Server Type    : MYSQL
Target Server Version : 50615
File Encoding         : 65001

Date: 2015-03-21 17:06:59
*/
...
-- ----------------------------
-- Table structure for dede_megagameinfo
-- ----------------------------
DROP TABLE IF EXISTS `dede_megagameinfo`;
CREATE TABLE `dede_megagameinfo` (
  `id` varchar(36) NOT NULL COMMENT 'id',
  `name` varchar(100) DEFAULT NULL COMMENT '名字',
  `videosrc` varchar(255) DEFAULT NULL COMMENT '视频链接',
  `img` varchar(255) DEFAULT NULL COMMENT '封面图链接',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dede_megagameinfo
-- ----------------------------
...
CREATE TABLE `t_mobile` (
  ...
  `phonenumber` varchar(50) NOT NULL COMMENT '电话号码',
  `virusname` varchar(100) NOT NULL COMMENT '病毒名称',
  `virustype` varchar(200) NOT NULL DEFAULT '' COMMENT '病毒类型',
  `virusdesc` varchar(500) NOT NULL COMMENT '病毒危害',
  `findtime` date NOT NULL COMMENT '发现时间',
  `advice` varchar(200) DEFAULT NULL COMMENT '处置方式',
  `creator` varchar(50) NOT NULL COMMENT '信息创建人',
  `createtime` date NOT NULL COMMENT '信息创建时间',
...
CREATE TABLE `t_notice` (
  ...
  `msg` varchar(1000) NOT NULL COMMENT '通告内容',
  `noticetype` varchar(2) NOT NULL COMMENT '通告类型代码',
...
-- ----------------------------
-- Table structure for t_queryconf
-- ----------------------------
DROP TABLE IF EXISTS `t_queryconf`;
CREATE TABLE `t_queryconf` (
  `id` varchar(36) NOT NULL COMMENT 'id',
  `typecode` int(11) NOT NULL COMMENT '用户查询类型代码',
  `typemsg` varchar(50) NOT NULL COMMENT '查询类型信息',
  `countlimit` int(11) NOT NULL DEFAULT '1' COMMENT '每日查询限制条数',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of t_queryconf
-- ----------------------------
INSERT INTO `t_queryconf` VALUES ('5a4355374a6d6f41014a6d9429320005', '0', '蠕虫', '3');
INSERT INTO `t_queryconf` VALUES ('5a4355374a6d6f41014a6d9471b10007', '1', '木马僵尸', '3');
INSERT INTO `t_queryconf` VALUES ('5a4355374a6d6f41014a6d94a6b10009', '2', '手机病毒', '3');
...
INSERT INTO `t_s_attachment` VALUES ('5a4355374c1720a1014c175ddd7e0005', null, 'Chrysanthemum', null, '2015-03-14 16:19:29', 'jpg', null, 'upload/files/20150314161929MYTL0f5U.jpg', 'org.jeecgframework.web.system.pojo.base.TSDocument', 'upload/files/20150314161929MYTL0f5U.swf', null, null, null);
INSERT INTO `t_s_attachment` VALUES ('5a4355374c1720a1014c175e19ab0007', null, 'Desert', null, '2015-03-14 16:19:45', 'jpg', null, 'upload/files/20150314161945CqKvEJZH.jpg', 'org.jeecgframework.web.system.pojo.base.TSDocument', 'upload/files/20150314161945CqKvEJZH.swf', null, null, null);
INSERT INTO `t_s_attachment` VALUES ('5a4355374c18f084014c1906f0240002', null, 'S@[0VL`IV[X9JEEGU){]Q`X', null, '2015-03-15 00:03:47', 'png', null, 'upload/files/20150315000347IfnPryhO.png', 'org.jeecgframework.web.system.pojo.base.TSDocument', 'upload/files/20150315000347IfnPryhO.swf', null, null, null);
INSERT INTO `t_s_attachment` VALUES ('5a4355374c1dfa97014c1e14a2680014', null, 'Chrysanthemum', null, '2015-03-15 23:36:50', 'jpg', null, 'upload/files/20150315233651m3Y02hdd.jpg', 'org.jeecgframework.web.system.pojo.base.TSDocument', 'upload/files/20150315233651m3Y02hdd.swf', null, null, null);
INSERT INTO `t_s_attachment` VALUES ('5a4355374c1dfa97014c1e26803a0036', null, 'Desert', null, '2015-03-15 23:56:21', 'jpg', null, 'upload/files/20150315235621tYc1jAEG.jpg', 'org.jeecgframework.web.system.pojo.base.TSDocument', 'upload/files/20150315235621tYc1jAEG.swf', null, null, null);
INSERT INTO `t_s_attachment` VALUES ('5a4355374c2211b9014c2213abbf0001', null, 'Chrysanthemum', null, '2015-03-16 18:14:16', 'jpg', null, 'upload/files/201503161814164xE6MnNh.jpg', 'org.jeecgframework.web.system.pojo.base.TSDocument', 'upload/files/201503161814164xE6MnNh.swf', null, null, null);
...
INSERT INTO `t_s_document` VALUES (null, null, null, null, '5a4355374c1720a1014c175ddd7e0005', '4028d881436d514601436d5216190053');
INSERT INTO `t_s_document` VALUES (null, null, null, null, '5a4355374c1720a1014c175e19ab0007', '4028d881436d514601436d5216190053');
INSERT INTO `t_s_document` VALUES (null, null, null, null, '5a4355374c18f084014c1906f0240002', '4028d881436d514601436d5216190053');
INSERT INTO `t_s_document` VALUES (null, null, null, null, '5a4355374c1dfa97014c1e14a2680014', '4028d881436d514601436d5216190053');
INSERT INTO `t_s_document` VALUES (null, null, null, null, '5a4355374c1dfa97014c1e26803a0036', '4028d881436d514601436d5216190053');
INSERT INTO `t_s_document` VALUES (null, null, null, null, '5a4355374c2211b9014c2213abbf0001', '4028d881436d514601436d5216190053');
...
INSERT INTO `t_s_function` VALUES ('5a43553b4a6c3144014a6c35b07b0001', null, '0', '网络安全信息管理', '001', '', null, '4028d881436d514601436d5214b30002', null);
INSERT INTO `t_s_function` VALUES ('5a43553b4a6c3144014a6c3622ba0003', null, '1', '手机病毒信息', '1', 'tMobileController.do?tMobile', '5a43553b4a6c3144014a6c35b07b0001', '4028d881436d514601436d5214b30002', null);
INSERT INTO `t_s_function` VALUES ('5a43553b4a6c3144014a6c371c5e0005', null, '1', '关注语配置信息', '2', 'tNoticeController.do?tNotice', '5a43553b4a6c3144014a6c35b07b0001', '4028d881436d514601436d5214b30002', null);
INSERT INTO `t_s_function` VALUES ('5a43553b4a6c3144014a6c37a6050007', null, '1', '类型信息', '3', 'tQueryconfController.do?tQueryconf', '5a43553b4a6c3144014a6c35b07b0001', '4028d881436d514601436d5214b30002', null);
...
INSERT INTO `t_s_log` VALUES ('5a4355374a6d6f41014a6d734bb30000', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.183', '2014-12-21 23:24:40', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374a6d6f41014a6d79828c0001', 'Chrome', '微信公众帐号信息更新成功', '5', '218.195.213.183', '2014-12-21 23:31:27', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374a6d6f41014a6d79a95f0002', 'Chrome', '用户admin已退出', '2', '218.195.213.183', '2014-12-21 23:31:37', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374a6d6f41014a6d79d1520003', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.183', '2014-12-21 23:31:47', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374a6d6f41014a6d8df1f40004', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.183', '2014-12-21 23:53:46', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374a6d6f41014a6d9429840006', 'Chrome', '类型信息添加成功', '3', '218.195.213.183', '2014-12-22 00:00:34', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374a6d6f41014a6d9471dd0008', 'Chrome', '类型信息添加成功', '3', '218.195.213.183', '2014-12-22 00:00:52', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374a6d6f41014a6d94a6cb000a', 'Chrome', '类型信息添加成功', '3', '218.195.213.183', '2014-12-22 00:01:06', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374a6d6f41014a6da63f04000b', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.183', '2014-12-22 00:20:19', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374a6d6f41014a6dcb2cb2000c', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.183', '2014-12-22 01:00:39', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374a6d6f41014a6dccf221000e', 'Chrome', '扩展接口管理添加成功', '3', '218.195.213.183', '2014-12-22 01:02:35', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374a6d6f41014a6dcd304f000f', 'Chrome', '扩展接口管理更新成功', '5', '218.195.213.183', '2014-12-22 01:02:51', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374a6d6f41014a6dce88060010', 'Chrome', '扩展接口管理更新成功', '5', '218.195.213.183', '2014-12-22 01:04:19', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374c13f7b0014c13f95ae70000', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-14 00:30:51', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c13f7b0014c13f9e2ef0001', 'Chrome', '用户xjwlaq已退出', '2', '218.195.213.183', '2015-03-14 00:31:25', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c13f7b0014c13fa5abc0002', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.183', '2015-03-14 00:31:56', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374c13f7b0014c13faf4c60003', 'Chrome', '扩展接口管理更新成功', '5', '218.195.213.183', '2015-03-14 00:32:36', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374c142ed1014c142f42050000', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-14 01:29:43', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c142ed1014c14310eb10002', 'Chrome', '微信公众帐号信息添加成功', '3', '218.195.213.183', '2015-03-14 01:31:41', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c142ed1014c143161a70003', 'Chrome', '用户xjwlaq已退出', '2', '218.195.213.183', '2015-03-14 01:32:02', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c142ed1014c1431817a0004', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-14 01:32:11', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c142ed1014c14319d270005', 'Chrome', '用户xjwlaq已退出', '2', '218.195.213.183', '2015-03-14 01:32:18', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c142ed1014c1431de6d0006', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.183', '2015-03-14 01:32:34', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374c142ed1014c1433355e000f', 'Chrome', '用户admin已退出', '2', '218.195.213.183', '2015-03-14 01:34:02', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374c142ed1014c143354b70010', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-14 01:34:10', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c142ed1014c143fc5f20011', 'Chrome', '用户xjwlaq已退出', '2', '218.195.213.183', '2015-03-14 01:47:46', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c142ed1014c14422aaa0012', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-14 01:50:22', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c142ed1014c14430e790015', 'Chrome', '删除信息数据成功！', '4', '218.195.213.183', '2015-03-14 01:51:21', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c142ed1014c144403110018', 'Chrome', '用户xjwlaq已退出', '2', '218.195.213.183', '2015-03-14 01:52:23', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c142ed1014c144457c70019', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.183', '2015-03-14 01:52:45', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374c142ed1014c144b0788001a', 'Chrome', '扩展接口管理更新成功', '5', '218.195.213.183', '2015-03-14 02:00:03', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374c142ed1014c144b69dd001c', 'Chrome', '扩展接口管理更新成功', '5', '218.195.213.183', '2015-03-14 02:00:28', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374c17013f014c170244590000', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-14 14:39:26', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c17013f014c170d433c0001', 'Chrome', '用户xjwlaq已退出', '2', '218.195.213.183', '2015-03-14 14:51:27', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c17013f014c170dbd000002', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.183', '2015-03-14 14:51:58', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374c17013f014c170e879a0009', 'Chrome', '用户admin已退出', '2', '218.195.213.183', '2015-03-14 14:52:50', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374c17013f014c170ea422000a', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-14 14:52:57', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c17013f014c170ebac1000b', 'Chrome', '用户xjwlaq已退出', '2', '218.195.213.183', '2015-03-14 14:53:03', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c17013f014c170f341d000c', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.183', '2015-03-14 14:53:34', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374c17013f014c17102be4000d', 'Chrome', '用户admin已退出', '2', '218.195.213.183', '2015-03-14 14:54:38', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374c17013f014c171048f7000e', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-14 14:54:45', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1720a1014c172787610002', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-14 15:20:08', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1720a1014c175ce95b0004', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-14 16:18:27', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1720a1014c175de5c20006', 'Chrome', '微站点模板更新成功', '5', '218.195.213.183', '2015-03-14 16:19:31', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1720a1014c175e1f0e0008', 'Chrome', '微站点信息更新成功', '5', '218.195.213.183', '2015-03-14 16:19:46', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1720a1014c176077260009', 'Chrome', '栏目管理更新成功', '5', '218.195.213.183', '2015-03-14 16:22:20', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1720a1014c1764e2b7000a', 'Chrome', '微站点模板更新成功', '5', '218.195.213.183', '2015-03-14 16:27:09', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1720a1014c17773662000f', 'Chrome', '用户xjwlaq已退出', '2', '218.195.213.183', '2015-03-14 16:47:10', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1720a1014c177765fa0010', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.183', '2015-03-14 16:47:23', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374c1720a1014c177babec0011', 'Chrome', '用户admin已退出', '2', '218.195.213.183', '2015-03-14 16:52:03', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374c1720a1014c177bc5ef0012', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-14 16:52:09', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1720a1014c177bed070013', 'Chrome', '删除null菜单信息数据', '4', '218.195.213.183', '2015-03-14 16:52:19', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1720a1014c1780e4180019', 'Chrome', '删除校内淘菜单信息数据', '4', '218.195.213.183', '2015-03-14 16:57:45', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1720a1014c17837cbe001a', 'Chrome', '删除校园导航菜单信息数据', '4', '218.195.213.183', '2015-03-14 17:00:35', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1720a1014c1783a786001b', 'Chrome', '删除工作兼职菜单信息数据', '4', '218.195.213.183', '2015-03-14 17:00:46', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1720a1014c17855783001c', 'Chrome', '删除病毒查询菜单信息数据', '4', '218.195.213.183', '2015-03-14 17:02:36', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1720a1014c17887287001d', 'Chrome', '同步菜单信息数据成功！', '4', '218.195.213.183', '2015-03-14 17:06:00', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1720a1014c178b0850001e', 'Chrome', '同步菜单信息数据成功！', '4', '218.195.213.183', '2015-03-14 17:08:49', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c17a201014c17aa45220000', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-14 17:42:57', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c17a201014c17aaf48b0001', 'Chrome', '微站点模板更新成功', '5', '218.195.213.183', '2015-03-14 17:43:41', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c17ac0e014c17b0efa20000', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-14 17:50:13', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c17ac0e014c17b11a2f0001', 'Chrome', '微站点模板删除成功', '4', '218.195.213.183', '2015-03-14 17:50:24', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c18f084014c18f119930000', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-14 23:39:56', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c18f084014c1900a1440001', 'Chrome', '信息更新成功', '5', '218.195.213.183', '2015-03-14 23:56:53', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c18f084014c190703090003', 'Chrome', '信息更新成功', '5', '218.195.213.183', '2015-03-15 00:03:52', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c18f084014c190a7a3c0005', 'Chrome', '信息添加成功', '3', '218.195.213.183', '2015-03-15 00:07:39', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1962fd014c1963f9aa0000', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-15 01:45:24', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1962fd014c196a5ca20001', 'Chrome', '信息更新成功', '5', '218.195.213.183', '2015-03-15 01:52:23', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1da320014c1dacb0400000', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-15 21:43:18', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1da320014c1dadb2870001', 'Chrome', '信息更新成功', '5', '218.195.213.183', '2015-03-15 21:44:24', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1da320014c1dafe02d0002', 'Chrome', '信息更新成功', '5', '218.195.213.183', '2015-03-15 21:46:47', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1da320014c1db13c0a0003', 'Chrome', '信息更新成功', '5', '218.195.213.183', '2015-03-15 21:48:16', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e0a5c580000', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-15 23:25:37', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e0dc7a40004', 'Chrome', '用户xjwlaq已退出', '2', '218.195.213.183', '2015-03-15 23:29:21', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e0df4020005', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-15 23:29:33', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e0f36480006', 'Chrome', '用户xjwlaq已退出', '2', '218.195.213.183', '2015-03-15 23:30:55', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e0f54b30007', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-15 23:31:03', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e0f66410008', 'Chrome', '用户xjwlaq已退出', '2', '218.195.213.183', '2015-03-15 23:31:07', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e0f90fa0009', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.183', '2015-03-15 23:31:18', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e101921000a', 'Chrome', '扩展接口管理更新成功', '5', '218.195.213.183', '2015-03-15 23:31:53', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e10c7d8000e', 'Chrome', '用户admin已退出', '2', '218.195.213.183', '2015-03-15 23:32:38', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e10e25c000f', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-15 23:32:45', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e14fe6d0016', 'Chrome', '微信单图消息添加成功', '3', '218.195.213.183', '2015-03-15 23:37:14', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e16215f0019', 'Chrome', '添加木马查询的信息成功！', '3', '218.195.213.183', '2015-03-15 23:38:29', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e19845f001a', 'Chrome', '删除微网站菜单信息数据', '4', '218.195.213.183', '2015-03-15 23:42:11', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e1aaf65001b', 'Chrome', '删除null菜单信息数据', '4', '218.195.213.183', '2015-03-15 23:43:27', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e1ae694001c', 'Chrome', '删除工作兼职菜单信息数据', '4', '218.195.213.183', '2015-03-15 23:43:41', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e1af8aa001d', 'Chrome', '删除故障报修菜单信息数据', '4', '218.195.213.183', '2015-03-15 23:43:46', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e1b55fd001e', 'Chrome', '更新校园导航的菜单信息信息成功！', '5', '218.195.213.183', '2015-03-15 23:44:10', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e1bc290001f', 'Chrome', '删除校内淘菜单信息数据', '4', '218.195.213.183', '2015-03-15 23:44:38', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e1bea390020', 'Chrome', '删除我的维修单菜单信息数据', '4', '218.195.213.183', '2015-03-15 23:44:48', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e1c3d420022', 'Chrome', '添加木马查询的信息成功！', '3', '218.195.213.183', '2015-03-15 23:45:09', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e1c71f70023', 'Chrome', '删除号码通菜单信息数据', '4', '218.195.213.183', '2015-03-15 23:45:22', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e1c7f490024', 'Chrome', '删除新生引导菜单信息数据', '4', '218.195.213.183', '2015-03-15 23:45:26', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e1cb2a30026', 'Chrome', '添加木马查询的信息成功！', '3', '218.195.213.183', '2015-03-15 23:45:39', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e1d15e30028', 'Chrome', '添加木马查询的信息成功！', '3', '218.195.213.183', '2015-03-15 23:46:04', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e1d83be0029', 'Chrome', '删除木马查询菜单信息数据', '4', '218.195.213.183', '2015-03-15 23:46:33', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e1dfc67002b', 'Chrome', '添加蠕虫查询的信息成功！', '3', '218.195.213.183', '2015-03-15 23:47:03', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e1e2950002c', 'Chrome', '更新蠕虫查询的菜单信息信息成功！', '5', '218.195.213.183', '2015-03-15 23:47:15', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e1f76a4002e', 'Chrome', '添加 手机查询的信息成功！', '3', '218.195.213.183', '2015-03-15 23:48:40', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e24b54d0031', 'Chrome', '添加帮助的信息成功！', '3', '218.195.213.183', '2015-03-15 23:54:24', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e24e8990032', 'Chrome', '同步菜单信息数据成功！', '4', '218.195.213.183', '2015-03-15 23:54:37', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e25c2280033', 'Chrome', '信息更新成功', '5', '218.195.213.183', '2015-03-15 23:55:33', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e25e4ec0034', 'Chrome', '信息更新成功', '5', '218.195.213.183', '2015-03-15 23:55:42', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e2622b30035', 'Chrome', '信息更新成功', '5', '218.195.213.183', '2015-03-15 23:55:58', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e2684410037', 'Chrome', '微站点信息更新成功', '5', '218.195.213.183', '2015-03-15 23:56:22', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e270a540038', 'Chrome', '用户xjwlaq已退出', '2', '218.195.213.183', '2015-03-15 23:56:57', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e27227c0039', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-15 23:57:03', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e274052003a', 'Chrome', '用户xjwlaq已退出', '2', '218.195.213.183', '2015-03-15 23:57:11', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e276de8003b', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.183', '2015-03-15 23:57:22', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c1e285f22003c', 'Chrome', '扩展接口管理更新成功', '5', '218.195.213.183', '2015-03-15 23:58:24', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c2066dc8b003d', 'MSIE 8.0', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-16 10:25:54', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c206ea85a003f', 'MSIE 8.0', '栏目管理更新成功', '5', '218.195.213.183', '2015-03-16 10:34:25', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c206f2c6f0040', 'MSIE 8.0', '栏目管理更新成功', '5', '218.195.213.183', '2015-03-16 10:34:59', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c206f77410041', 'MSIE 8.0', '栏目管理更新成功', '5', '218.195.213.183', '2015-03-16 10:35:18', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c206fceca0042', 'MSIE 8.0', '栏目管理更新成功', '5', '218.195.213.183', '2015-03-16 10:35:40', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c207073f70043', 'MSIE 8.0', '栏目管理更新成功', '5', '218.195.213.183', '2015-03-16 10:36:22', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c2070d2a70044', 'MSIE 8.0', '栏目管理更新成功', '5', '218.195.213.183', '2015-03-16 10:36:47', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c207160aa0045', 'MSIE 8.0', '栏目管理更新成功', '5', '218.195.213.183', '2015-03-16 10:37:23', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c20720fb30046', 'MSIE 8.0', '栏目管理更新成功', '5', '218.195.213.183', '2015-03-16 10:38:08', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c207265670047', 'MSIE 8.0', '栏目管理更新成功', '5', '218.195.213.183', '2015-03-16 10:38:30', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c207300fb0048', 'MSIE 8.0', '栏目管理更新成功', '5', '218.195.213.183', '2015-03-16 10:39:10', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c20736c810049', 'MSIE 8.0', '栏目管理更新成功', '5', '218.195.213.183', '2015-03-16 10:39:37', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c2073bc52004a', 'MSIE 8.0', '栏目管理删除成功', '4', '218.195.213.183', '2015-03-16 10:39:58', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c207b9658004b', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-16 10:48:32', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c20818fd0004c', 'Chrome', '信息更新成功', '5', '218.195.213.183', '2015-03-16 10:55:04', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c2081cdb3004d', 'Chrome', '信息删除成功', '4', '218.195.213.183', '2015-03-16 10:55:19', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c2086108c004e', 'Chrome', '信息更新成功', '5', '218.195.213.183', '2015-03-16 10:59:59', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c20899d45004f', 'Chrome', '信息更新成功', '5', '218.195.213.183', '2015-03-16 11:03:51', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c208c1a950050', 'Chrome', '信息更新成功', '5', '218.195.213.183', '2015-03-16 11:06:35', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c208ec9be0051', 'Chrome', '首页广告更新成功', '5', '218.195.213.183', '2015-03-16 11:09:30', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c208f06690052', 'Chrome', '首页广告更新成功', '5', '218.195.213.183', '2015-03-16 11:09:46', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c208f52430053', 'Chrome', '首页广告更新成功', '5', '218.195.213.183', '2015-03-16 11:10:05', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c208f91c10054', 'Chrome', '首页广告更新成功', '5', '218.195.213.183', '2015-03-16 11:10:22', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c2100d3890056', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-16 13:14:04', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c1dfa97014c210195920057', 'Chrome', '信息更新成功', '5', '218.195.213.183', '2015-03-16 13:14:54', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c2211b9014c2212d16b0000', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-16 18:13:20', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c2211b9014c2213c5880002', 'Chrome', '微站点信息更新成功', '5', '218.195.213.183', '2015-03-16 18:14:23', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c221a71014c229551f80000', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-16 20:35:53', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c2667a9014c2686f5400000', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-17 14:58:41', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c2667a9014c268abfe40001', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-17 15:02:49', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c2667a9014c2cc3d7d80005', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-18 20:02:54', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c2667a9014c2cc980330006', 'Chrome', '信息更新成功', '5', '218.195.213.183', '2015-03-18 20:09:05', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c2667a9014c2cd48b7d0007', 'Chrome', '信息更新成功', '5', '218.195.213.183', '2015-03-18 20:21:09', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c2667a9014c2d566e710008', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-18 22:43:01', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c2667a9014c2d57651e0009', 'Chrome', '信息更新成功', '5', '218.195.213.183', '2015-03-18 22:44:04', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c325602014c325b73630000', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-19 22:06:36', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a4355374c3b2120014c3b232ab60000', 'Chrome', '用户: xjwlaq[信息部]登录成功', '1', '218.195.213.183', '2015-03-21 15:01:42', '1', '5a43553b4a90dbfa014a90e9e2050016');
INSERT INTO `t_s_log` VALUES ('5a43553b4a5ce2d4014a5ce7a6b90000', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.187', '2014-12-18 18:18:13', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a5ce2d4014a5cebbef4002b', 'Chrome', '用户admin已退出', '2', '218.195.213.187', '2014-12-18 18:22:41', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a61e6b4014a61e782650000', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.187', '2014-12-19 17:36:09', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a61e6b4014a61ff35b70001', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.187', '2014-12-19 18:02:03', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a61e6b4014a6211fc060002', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.187', '2014-12-19 18:22:33', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a61e6b4014a621424240003', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.187', '2014-12-19 18:24:54', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a61e6b4014a6214a8ed0004', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.187', '2014-12-19 18:25:28', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a61e6b4014a621509130005', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.187', '2014-12-19 18:25:53', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a667670014a668d6a920000', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.187', '2014-12-20 15:15:51', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a6c3144014a6c3229f80000', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.187', '2014-12-21 17:33:54', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a6c3144014a6c35b0c60002', 'Chrome', '权限: 网络安全信息管理被添加成功', '3', '218.195.213.187', '2014-12-21 17:37:45', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a6c3144014a6c3622f20004', 'Chrome', '权限: 手机病毒信息被添加成功', '3', '218.195.213.187', '2014-12-21 17:38:14', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a6c3144014a6c371c7f0006', 'Chrome', '权限: 关注语配置信息被添加成功', '3', '218.195.213.187', '2014-12-21 17:39:18', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a6c3144014a6c37a62a0008', 'Chrome', '权限: 类型信息被添加成功', '3', '218.195.213.187', '2014-12-21 17:39:54', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a6c3144014a6c382ede000a', 'Chrome', '权限: 蠕虫信息被添加成功', '3', '218.195.213.187', '2014-12-21 17:40:29', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a6c3144014a6c38917d000c', 'Chrome', '权限: 用户查询信息被添加成功', '3', '218.195.213.187', '2014-12-21 17:40:54', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a6c3144014a6c3913f1000e', 'Chrome', '权限: 木马信息被添加成功', '3', '218.195.213.187', '2014-12-21 17:41:27', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a6c3144014a6c3971200016', 'Chrome', '用户admin已退出', '2', '218.195.213.187', '2014-12-21 17:41:51', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a6c3144014a6c399cc60017', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.187', '2014-12-21 17:42:02', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a6c3ccf014a6c3d33f70000', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.187', '2014-12-21 17:45:58', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a721a47500000', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.187', '2014-12-22 21:05:32', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a721c5aae0001', 'Chrome', '权限: 广告管理被删除成功', '4', '218.195.213.187', '2014-12-22 21:07:48', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a721c6ee00002', 'Chrome', '权限: 栏目管理被删除成功', '4', '218.195.213.187', '2014-12-22 21:07:53', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a721c814f0003', 'Chrome', '权限: 文章管理被删除成功', '4', '218.195.213.187', '2014-12-22 21:07:58', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a721c93550004', 'Chrome', '权限: 网站信息被删除成功', '4', '218.195.213.187', '2014-12-22 21:08:03', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a721ca5a80005', 'Chrome', '权限: 网站模板被删除成功', '4', '218.195.213.187', '2014-12-22 21:08:07', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a721cb3710006', 'Chrome', '权限: 微信网站被删除成功', '4', '218.195.213.187', '2014-12-22 21:08:11', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a721d3a610007', 'Chrome', '权限: 微大转盘被删除成功', '4', '218.195.213.187', '2014-12-22 21:08:45', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a721d501b0008', 'Chrome', '权限: 微信刮刮乐被删除成功', '4', '218.195.213.187', '2014-12-22 21:08:51', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a721d65360009', 'Chrome', '权限: 微相册被删除成功', '4', '218.195.213.187', '2014-12-22 21:08:56', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a721d738e000a', 'Chrome', '权限: 微活动被删除成功', '4', '218.195.213.187', '2014-12-22 21:09:00', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a721e9519000b', 'Chrome', '权限: 表单验证被删除成功', '4', '218.195.213.187', '2014-12-22 21:10:14', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a721f5632000c', 'Chrome', '权限: 多附件管理被删除成功', '4', '218.195.213.187', '2014-12-22 21:11:03', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a72207db7000d', 'Chrome', '权限: 一对多模型被删除成功', '4', '218.195.213.187', '2014-12-22 21:12:19', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a7220c844000e', 'Chrome', '权限: Excel导入导出被删除成功', '4', '218.195.213.187', '2014-12-22 21:12:38', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a72212595000f', 'Chrome', '权限: 无分页列表被删除成功', '4', '218.195.213.187', '2014-12-22 21:13:02', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a722167d90010', 'Chrome', '权限: jdbc示例被删除成功', '4', '218.195.213.187', '2014-12-22 21:13:19', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a722196980011', 'Chrome', '权限: SQL分离被删除成功', '4', '218.195.213.187', '2014-12-22 21:13:31', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a7221cd1b0012', 'Chrome', '权限: 字典标签被删除成功', '4', '218.195.213.187', '2014-12-22 21:13:45', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a7221f7830013', 'Chrome', '权限: JqueryFile示例被删除成功', '4', '218.195.213.187', '2014-12-22 21:13:56', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a722224730014', 'Chrome', '权限: 表单弹出风格被删除成功', '4', '218.195.213.187', '2014-12-22 21:14:07', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a72225a580015', 'Chrome', '权限: 特殊布局被删除成功', '4', '218.195.213.187', '2014-12-22 21:14:21', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a7222a3c30016', 'Chrome', '权限: 单表例子(无Tag)被删除成功', '4', '218.195.213.187', '2014-12-22 21:14:40', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a7222cf2f0017', 'Chrome', '权限: 一对多例子(无Tag)被删除成功', '4', '218.195.213.187', '2014-12-22 21:14:51', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a7222f85d0018', 'Chrome', '权限: HTML编辑器被删除成功', '4', '218.195.213.187', '2014-12-22 21:15:02', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a722320f10019', 'Chrome', '权限: 在线word(IE)被删除成功', '4', '218.195.213.187', '2014-12-22 21:15:12', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a72234cf4001a', 'Chrome', '权限: WebOffice官方例子被删除成功', '4', '218.195.213.187', '2014-12-22 21:15:23', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a7223a6ce001b', 'Chrome', '权限: 物料Bom被删除成功', '4', '218.195.213.187', '2014-12-22 21:15:46', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a7223df80001c', 'Chrome', '权限: ckfinder例子被删除成功', '4', '218.195.213.187', '2014-12-22 21:16:01', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a72251f93001d', 'Chrome', '用户admin已退出', '2', '218.195.213.187', '2014-12-22 21:17:23', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a72254bb4001e', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.187', '2014-12-22 21:17:34', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a7240c52b001f', 'Chrome', '用户: admin[信息部]登录成功', '1', '218.195.213.187', '2014-12-22 21:47:35', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a724ae2f8002a', 'Chrome', '删除信息数据成功！', '4', '218.195.213.187', '2014-12-22 21:58:38', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a724af443002b', 'Chrome', '删除信息数据成功！', '4', '218.195.213.187', '2014-12-22 21:58:42', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a724b0df3002c', 'Chrome', '删除信息数据成功！', '4', '218.195.213.187', '2014-12-22 21:58:49', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a724b240d002d', 'Chrome', '删除信息数据成功！', '4', '218.195.213.187', '2014-12-22 21:58:54', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a724e4bda0030', 'Chrome', '扩展接口管理更新成功', '5', '218.195.213.187', '2014-12-22 22:02:21', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a724e65960031', 'Chrome', '扩展接口管理更新成功', '5', '218.195.213.187', '2014-12-22 22:02:28', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a724e8dab0032', 'Chrome', '扩展接口管理更新成功', '5', '218.195.213.187', '2014-12-22 22:02:38', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a724eab140033', 'Chrome', '扩展接口管理更新成功', '5', '218.195.213.187', '2014-12-22 22:02:45', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a724ecbde0034', 'Chrome', '扩展接口管理更新成功', '5', '218.195.213.187', '2014-12-22 22:02:54', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a724ee28e0035', 'Chrome', '扩展接口管理更新成功', '5', '218.195.213.187', '2014-12-22 22:03:00', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a724effe60036', 'Chrome', '扩展接口管理更新成功', '5', '218.195.213.187', '2014-12-22 22:03:07', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a724f6e540037', 'Chrome', '删除信息数据成功！', '4', '218.195.213.187', '2014-12-22 22:03:35', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a724f7e460038', 'Chrome', '删除信息数据成功！', '4', '218.195.213.187', '2014-12-22 22:03:39', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a724fa8e70039', 'Chrome', '删除信息数据成功！', '4', '218.195.213.187', '2014-12-22 22:03:50', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a724fb8c6003a', 'Chrome', '删除信息数据成功！', '4', '218.195.213.187', '2014-12-22 22:03:54', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a724fcacf003b', 'Chrome', '删除信息数据成功！', '4', '218.195.213.187', '2014-12-22 22:03:59', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a72507dd4003c', 'Chrome', '删除信息数据成功！', '4', '218.195.213.187', '2014-12-22 22:04:45', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a7250948d003d', 'Chrome', '删除信息数据成功！', '4', '218.195.213.187', '2014-12-22 22:04:51', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a7251c638003e', 'Chrome', '修改关文本模板成功！', '5', '218.195.213.187', '2014-12-22 22:06:09', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a7252262a003f', 'Chrome', '删除联系我们菜单信息数据', '4', '218.195.213.187', '2014-12-22 22:06:34', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a725244700040', 'Chrome', '删除社区培训菜单信息数据', '4', '218.195.213.187', '2014-12-22 22:06:41', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a7252550c0041', 'Chrome', '删除关于我们菜单信息数据', '4', '218.195.213.187', '2014-12-22 22:06:46', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a72526b9f0042', 'Chrome', '删除营销工具菜单信息数据', '4', '218.195.213.187', '2014-12-22 22:06:51', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a72528d310043', 'Chrome', '删除微商城菜单信息数据', '4', '218.195.213.187', '2014-12-22 22:07:00', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a7252c1bd0044', 'Chrome', '删除微网站菜单信息数据', '4', '218.195.213.187', '2014-12-22 22:07:13', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a7252d8a10045', 'Chrome', '删除刮刮乐菜单信息数据', '4', '218.195.213.187', '2014-12-22 22:07:19', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a7252e89a0046', 'Chrome', '删除微活动菜单信息数据', '4', '218.195.213.187', '2014-12-22 22:07:23', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a7252fea90047', 'Chrome', '删除开源微信系统菜单信息数据', '4', '218.195.213.187', '2014-12-22 22:07:29', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a725314360048', 'Chrome', '删除快速开发平台菜单信息数据', '4', '218.195.213.187', '2014-12-22 22:07:34', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a7253225d0049', 'Chrome', '删除开源项目菜单信息数据', '4', '218.195.213.187', '2014-12-22 22:07:38', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a72533b96004a', 'Chrome', '同步菜单信息数据失败！错误码为：40016错误信息为：invalid button size', '4', '218.195.213.187', '2014-12-22 22:07:45', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a7254e2ee004b', 'Chrome', '同步菜单信息数据失败！错误码为：40016错误信息为：invalid button size', '4', '218.195.213.187', '2014-12-22 22:09:33', '1', '4028d881436d514601436d5215ac0043');
INSERT INTO `t_s_log` VALUES ('5a43553b4a7218e2014a72554b81004d', 'Chrome', '添加12312312的信息成功！', '3', '218.195.213.187', '2014-12-22 22:10:00', '1', '4028d881436d514601436d5215ac0043');
...
INSERT INTO `t_s_role_function` VALUES ('5a4355374c142ed1014c143325090008', null, '297e7eb6469a4a8901469a54eff60006', '5a43553b4a90dbfa014a90e4a7640001');
INSERT INTO `t_s_role_function` VALUES ('5a4355374c142ed1014c143325090009', null, '402889f64747048401474707902e0003', '5a43553b4a90dbfa014a90e4a7640001');
INSERT INTO `t_s_role_function` VALUES ('5a4355374c142ed1014c14332509000a', null, '402889f64747048401474706d2a50001', '5a43553b4a90dbfa014a90e4a7640001');
INSERT INTO `t_s_role_function` VALUES ('5a4355374c142ed1014c14332509000b', null, '402881e44695183a0146951ed79e0008', '5a43553b4a90dbfa014a90e4a7640001');
INSERT INTO `t_s_role_function` VALUES ('5a4355374c142ed1014c14332509000c', null, '402881e44695183a0146951af2b70004', '5a43553b4a90dbfa014a90e4a7640001');
INSERT INTO `t_s_role_function` VALUES ('5a4355374c142ed1014c1433250a000e', null, '402881e44695183a0146951b66050006', '5a43553b4a90dbfa014a90e4a7640001');
INSERT INTO `t_s_role_function` VALUES ('5a4355374c17013f014c170e1b740003', null, '402881e44695183a0146951b66050006', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a4355374c17013f014c170e1b770004', null, '402889f64747048401474706d2a50001', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a4355374c17013f014c170e1b770005', null, '402881e44695183a0146951ed79e0008', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a4355374c17013f014c170e1b780006', null, '402889f64747048401474707902e0003', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a4355374c17013f014c170e1b780007', null, '297e7eb6469a4a8901469a54eff60006', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a4355374c17013f014c170e1b780008', null, '402881e44695183a0146951af2b70004', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a5ce2d4014a5ce8e9fd0001', null, '4028d881436d514601436d52153b0029', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a5ce2d4014a5ce8ea000002', null, '4028d881436d514601436d52155a0030', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a5ce2d4014a5ce8ea000005', null, '4028d881436d514601436d54b1bf018d', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a5ce2d4014a5ce8ea010008', null, '4028d881436d514601436d5215340027', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a5ce2d4014a5ce8ea010009', null, '4028d881436d514601436d521540002a', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a5ce2d4014a5ce8ea01000a', null, '4028d881436d514601436d521593003f', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a5ce2d4014a5ce8ea01000c', null, '4028d881436d514601436d52150d001b', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a5ce2d4014a5ce8ea01000d', null, '4028d881436d514601436d5215290024', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a5ce2d4014a5ce8ea010013', null, '4028d881436d514601436d5215300026', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a5ce2d4014a5ce8ea010014', null, '4028d881436d514601436d52150b001a', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a5ce2d4014a5ce8ea010015', null, '4028d881436d514601436d58ff5e01a1', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a5ce2d4014a5ce8eabf0019', null, '4028d881436d514601436d592bef01a3', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a5ce2d4014a5ce8eabf001b', null, '4028d881436d514601436d56555e0193', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a5ce2d4014a5ce8eabf001c', null, '4028d881436d514601436d5215260023', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a5ce2d4014a5ce8eabf001d', null, '4028d881436d514601436d52150f001c', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a5ce2d4014a5ce8eabf001e', null, '4028d881436d514601436d52158a003d', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a5ce2d4014a5ce8eabf001f', null, '4028d881436d514601436d5215380028', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a5ce2d4014a5ce8eac00022', null, '4028d881436d514601436d52152c0025', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a5ce2d4014a5ce8eac00025', null, '4028d881436d514601436d5215070018', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a5ce2d4014a5ce8eac10027', null, '4028d881436d514601436d5b3b7001b3', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a5ce2d4014a5ce8eac10028', null, '4028d881436d514601436d5a18e601a9', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a5ce2d4014a5ce8ead6002a', null, '4028d881436d514601436d53fee50187', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a6c3144014a6c395ab7000f', null, '5a43553b4a6c3144014a6c382ec50009', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a6c3144014a6c395ae70010', null, '5a43553b4a6c3144014a6c35b07b0001', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a6c3144014a6c395ae70011', null, '5a43553b4a6c3144014a6c389157000b', '4028d881436d514601436d52159c0041');
INSERT INTO `t_s_role_function` VALUES ('5a43553b4a6c3144014a6c395ae70012', null, '5a43553b4a6c3144014a6c3622ba0003', '4028d881436d514601436d52159c0041');
...
-- ----------------------------
-- Table structure for t_trojan
-- ----------------------------
DROP TABLE IF EXISTS `t_trojan`;
CREATE TABLE `t_trojan` (
  `id` varchar(36) NOT NULL COMMENT '流水号',
  `ip` varchar(50) NOT NULL COMMENT 'ip地址',
  `eventtype` varchar(100) NOT NULL COMMENT '事件类型',
  `detailtype` varchar(200) NOT NULL DEFAULT '' COMMENT '事件详细类型',
  `findtime` date NOT NULL COMMENT '发现时间',
  `advice` varchar(200) NOT NULL COMMENT '处置方式',
  `creator` varchar(50) NOT NULL COMMENT '信息创建人',
  `createtime` date NOT NULL COMMENT '信息创建时间',
  `memo` varchar(200) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
...
-- ----------------------------
DROP TABLE IF EXISTS `t_userquery`;
CREATE TABLE `t_userquery` (
  `id` varchar(36) NOT NULL COMMENT '流水号',
  `usercode` varchar(50) NOT NULL COMMENT '用户微信号',
  `typecode` int(11) NOT NULL COMMENT '查询类型代码',
...
-- ----------------------------
INSERT INTO `t_userquery` VALUES ('5a4355374c1720a1014c177d88db0018', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '1', '2015-03-14', null);
INSERT INTO `t_userquery` VALUES ('5a4355374c1dfa97014c1e107b6d000d', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '1', '2015-03-15', null);
...
-- ----------------------------
DROP TABLE IF EXISTS `t_worms`;
CREATE TABLE `t_worms` (
  `id` varchar(36) NOT NULL COMMENT '流水号',
  `ip` varchar(50) NOT NULL COMMENT 'ip地址',
  `eventtype` varchar(100) NOT NULL COMMENT '事件类型',
  `detailtype` varchar(200) NOT NULL DEFAULT '' COMMENT '事件详细类型',
...
-- ----------------------------
INSERT INTO `weixin_account` VALUES ('5a4355374c142ed1014c14310e790001', '新疆网络安全预警平台', 'basewx', 'gh_985d88f8eb37', '2', 'guanghezhu@163.com', '无', 'vsHqXcizB9CvWJZnLBf950p-SxnviBQ71hbCg-qdUH6YSUjR8AcIPBbk6nk-CnDDMo1QCggUW1rf1X9U9LtS4NLdkbrE9D3zETSlqvL0jQc', 'wxae56f3bb52465835', 'ca536b921fbffe36751a1970244e19bd', '2015-03-15 23:54:37', 'xjwlaq', 'gh_985d88f8eb37');
...
-- ----------------------------
INSERT INTO `weixin_autoresponse` VALUES ('402889ff4728a293014728b0c7da001b', '2014-07-12 11:49:39', '01', 'text', 'f7a8a3a946e55a940146e5a3e498004d', '微译使用指南', '5a4355374c142ed1014c14310e790001s');
INSERT INTO `weixin_autoresponse` VALUES ('f7a8a3a946e249c20146e26a10ca0019', '2014-06-28 20:19:00', '?', 'text', 'f7a8a3a946e249c20146e25c4dc7000c', '欢迎关注语', '5a4355374c142ed1014c14310e79000s1');
...
-- ----------------------------
INSERT INTO `weixin_cms_ad` VALUES ('402881e44695183a014695214a510013', '5a4355374c142ed1014c14310e790001', 'admin', '2014-06-13 20:08:45', '管理员', 'upload/files/20140627233502FEzyc38j.jpg', '19300001024098134717639977056.jpg', 'IPHONE7', 'N', '4', '');
INSERT INTO `weixin_cms_ad` VALUES ('402881e44695183a014695219fe70016', '5a4355374c142ed1014c14310e790001', 'admin', '2014-06-13 20:09:07', '管理员', 'upload/files/20140627232736z3SvfVEj.jpg', '634490825089531250.jpg', 'IPHONE', 'N', '3', '');
INSERT INTO `weixin_cms_ad` VALUES ('402881e946ddea480146de053265000b', '5a4355374c142ed1014c14310e790001', '4028d881436d514601436d5215ac0043', '2014-06-27 23:50:21', 'admin', 'upload/files/20140627235534VJM1pkx3.jpg', 'Img305735292.jpg', '黑莓', 'N', '2', '');
INSERT INTO `weixin_cms_ad` VALUES ('402881e946ddea480146de0f3a810011', '5a4355374c142ed1014c14310e790001', '4028d881436d514601436d5215ac0043', '2014-06-28 00:01:18', 'admin', 'upload/files/20140628000116OF07rm7E.jpg', '30_1i$1JxIOB.jpg', 'Lumia930 王者归来', 'N', '1', '');
...
-- ----------------------------
INSERT INTO `weixin_cms_article` VALUES ('297e7eb6469a4a8901469a5e58c0000e', '上海加快完善信息安全保障体系 推动地方立法', '19343396_845725.jpg', 'upload/files/20140613235146eEgyESpy.jpg', '上海加快完善信息安全保障体系 推动地方立法', '<p>&nbsp; 3月5日，上海市智慧城市信息安全保障工作会议举行。会议表示，面对信息安全事件高发的新常态，上海市将加快完善信息安全保障体系，推动个人信息保护和关键信息基础设施防护等地方立法。</p><p>&nbsp; 据分析，目前上海的信息安全工作面临四方面挑战：一是中央对上海提出了建设具有全球影响力的科创中心的要求；二是城市运行已高度依赖网络和信息系统，信息安全事件高发将成为新常态；三是移动互联网、物联网、大数据等新技术将使信息安全面临新情况；四是市民对打击涉网犯罪、保护个人信息安全等方面提出了更多新期待。</p><p>&nbsp; 面对挑战，上海将重点做好政府公共数据资源开放、网上政务大厅、信用报告在线查询等重点项目的安全保障，加强基础网络、重要网站和信息系统、城市生命线系统及重要工控系统的梳理和检查。此外，上海市还将加快推动立法，营造良好的社会环境；并通过自主创新技术的转化应用、吸引信息安全领军人物来沪发展等举措，充分发挥各类市场主体对于保障信息安全的作用。</p><p><br/></p>', '402881e44695183a0146952426ce0022', '5a4355374c142ed1014c14310e790001', '管理员', 'admin', '2014-06-14 20:33:33', '5');
INSERT INTO `weixin_cms_article` VALUES ('297e7eb6469a4a8901469a5ef95c0011', '关于1月21日我国境内互联网访问异常情况的通报', '1384480985636.jpg', 'upload/files/20140613235146eEgyESpy.jpg', '关于1月21日我国境内互联网访问异常情况的通报', '<p>&nbsp; 2014年1月21日15:20，中国境内大量互联网用户无法正常访问域名以“.com”、“.net”等结尾的网站。事件发生后，国家互联网应急中心第一时间启动应急响应机制，协调组织部分技术支撑单位进行调查和应急处置，16:50左右，用户访问基本恢复正常。</p><p>&nbsp; 经对已掌握的数据进行分析，初步判断此次事件是由于网络攻击导致我国境内互联网用户通过国际顶级域名服务解析时出现异常，攻击来源正在进一步调查中。</p><p><br/></p>', '402881e44695183a01469523f03a001f', '5a4355374c142ed1014c14310e790001', '管理员', 'admin', '2014-06-14 20:34:14', '4');
INSERT INTO `weixin_cms_article` VALUES ('402889f346dc66c30146dc7c1c120002', '关于警惕近期多发NTP反射放大攻击的预警通报', '1348502732_4991.gif', 'upload/files/20140613235146eEgyESpy.jpg', '关于警惕近期多发NTP反射放大攻击的预警通报', '<ul class=\"waring_con2 list-paddingleft-2\"><p style=\"line-height: 16px;\"><br/></p><p style=\"line-height: 16px;\">&nbsp; 近期，CNCERT监测到我国公共互联网上发生多起NTP反射放大攻击事件，攻击流量逐步增大，且有进一步扩大蔓延的趋势。CNCERT还收到日本计算机应急响应组织（JPCERT）通报，称近期日本国内也发生了多起类似事件。同时，中国电信报告，近日网内此类攻击事件流量高达300G。现将预警信息通报如下：<br/></p><p>&nbsp;&nbsp;<strong>一、NTP和NTP反射放大攻击</strong></p><p>&nbsp; NTP是网络时间协议（Network Time \r\nProtocol）的简称，它可以使计算机对其服务器或时钟源（如石英钟、GPS等）做同步化，提供精准度的时间校正。</p><p>&nbsp; NTP使用UDP 123端口，其包含一个 monlist 功能，NTP \r\n服务器收到monlist请求后最多会返回100个响应包，因此攻击主机可伪造受害主机的IP地址，向网上的NTP服务器发送monlist请求，NTP \r\n服务器向受害主机返回大量的数据包从而造成其网络拥塞，从而达到攻击目的，其反射放大效果可达200倍。这是一种典型的分布式反射拒绝服务（DRDoS）攻击方式。</p><p>&nbsp; NTP \r\nDRDoS攻击给互联网的正常安全运行带来了极大影响。一方面，利用NTP服务可以把攻击流量轻易放大几十到几百倍，一旦被黑客大规模利用，耗尽NTP服务器和路由器的计算资源，耗费掉有限的互联网带宽；另一方面，DRDoS攻击隐藏了僵尸主机的IP地址，极大地增加了基础电信企业对DRDoS攻击追踪溯源的难度，给互联网稳定运行带来巨大威胁。</p><p>&nbsp;&nbsp;<strong>二、近期NTP DRDoS攻击监测情况</strong></p><p>&nbsp;&nbsp;<strong>（一）CNCERT监测情况</strong></p><p>&nbsp; 经CNCERT监测数据初步分析，互联网上开放UDP&nbsp;123端口的服务器约有80万台。其中，频繁被请求的服务器约为1800台，粗略计算，若这 \r\n1800台NTP服务器每台均收到1M的请求流量，总共会反射发出360G的攻击流量，造成互联网严重阻塞。在监测发现的被请求次数最多的前50个NTP \r\n服务器，其IP地址主要位于美国（56%）和中国（26%）。</p><p>&nbsp;&nbsp;<strong>（二）国外相关机构监测情况</strong></p><p>&nbsp; 2月，CNCERT接到JPCERT通报，称从2013年11月起，日本多个机构监测到互联网上发生多起NTP \r\nDRDoS攻击事件。但目前针对NTP服务器的攻击流量较小，且攻击源IP每周更换攻击对象，因此推测攻击者在对互联网上的NTP服务器进行恶意扫描，以寻找可攻击的潜在对象，有可能准备发动新一轮的大型NTP DRDoS攻击。</p><p>&nbsp; 计算机应急响应组织CERT/CC也发出预警信息，称思科和惠普等生产的支持NTP服务的网络设备都有可能面临上述风险，并给出具体防范建议。</p><p>&nbsp;&nbsp;<strong>（三）中国电信监测和处置情况</strong></p><p>&nbsp; 据中国电信报告，近期国内互联网存在大量利用NTP等服务进行DRDoS攻击的行为，攻击流量从1月6日起逐步变大，单个攻击流量从之前数十M的规模增长逐渐增长到目前的几十G，最大导致上百G的反射攻击流量，且绝大部分攻击流量来自国外，范围和危害均前所未有，其中思科、阿尔卡特朗讯的部分设备受影响较大。</p><p>&nbsp; 在此情况下，中国电信检查了其骨干网所有核心路由器的NTP配置，并发现有部分接入侧路由器已受到过NTP \r\nDRDoS攻击。2月初，中国电信开始在国际出入口和互联互通层面对NTP流量进行整体调控，其国际出入口的NTP流量从300G降低到几十G，效果明显，有效减少了国外对我国内的NTP反射攻击。</p><p>&nbsp;&nbsp;<strong>三、对策建议</strong></p><p>&nbsp; 目前，国内大量服务器和网络设备均开放了UDP \r\n123端口，因此极易构成一个巨大的可被利用的僵尸网络，而目前基础电信运营企业对此尚无法做到完全有效控制。建议各基础电信企业、重要信息系统运行单位等进一步加强安全威胁防范：</p><p>&nbsp; （一）思科、Juniper已在其官网公布受NTP&nbsp;DRDoS攻击影响的服务器版本，其余设备厂商尚未针对此类攻击发布受影响版本。建议各单位继续加强关注，尽快将受影响的NTP服务器ntpd程序升级到4.2.7版本及以上。</p><p>&nbsp; （二）进一步加强异常流量监测，对NTP流量过大的自有系统服务器进行NTP访问控制，或限制NTP服务器的流出流量。</p><p>&nbsp; （三）根据中国电信采取的积极经验，建议各基础电信企业在国际出入口和互联互通层面对NTP流量进行监测和调控，降低来自国外大规模NTP&nbsp;DRDoS攻击的可能性。</p><p>&nbsp; （四）各基础电信企业应在全网范围内切实认真组织实施源地址验证，按要求深入推进虚假源地址整治工作，建设完善流监测技术手段，增强对DRDoS攻击的监测发现和分析能力。</p><p>&nbsp; CNCERT也将对此类NTP&nbsp;DRDoS攻击行为进行有针对性的监测和通报，及时发布预警信息，会同相关单位防范和处置利用NTP等服务进行DRDoS攻击的黑客行为。</p><p>&nbsp;</p><p>&nbsp; 注：感谢中国电信集团公司SOC团队提供的监测数据和技术支持。</p></ul><p><br/></p>', '402881e44695183a014695234880001c', '5a4355374c142ed1014c14310e790001', 'admin', '4028d881436d514601436d5215ac0043', '2014-06-27 16:40:59', '10');
INSERT INTO `weixin_cms_article` VALUES ('5a4355374c18f084014c190a7a1c0004', '关于Windows OLE组件存在远程代码执行高危漏洞的情况公告', '', '', '关于Windows OLE组件存在远程代码执行高危漏洞的情况公告', '<ul class=\"waring_con2 list-paddingleft-2\"><p style=\"line-height: 16px;\"><br/></p><p>&nbsp;10月15日，CNVD收录了最新披露的Windows \r\nOLE远程代码执行漏洞（CNVD-2014-06717,对应CVE-2014-4114）。目前，官方已经提供了漏洞的修复补丁。攻击者可通过精心构造包含文件并诱使用户执行文件触发远程代码执行漏洞，进而控制用户操作系统主机。<br/></p><p><strong>一、漏洞情况分析</strong></p><p>&nbsp; OLE（对象链接与嵌入）是一种允许应用程序共享数据和功能的技术，用来增强Windows应用程序之间相互协作性。Microsoft \r\nOffice文档也可以使用OLE对象。Windows \r\nOLE组件功能中存在一个远程代码执行漏洞，漏洞产生的原因是某些特制的OLE对象可加载并执行远程INF文件，而INF文件是Windows的安装信息文件，里面包含需要下载并安装的软件信息，攻击者可通过INF文件中设定的远程恶意可执行程序进行下载，通过操作注册表信息，执行成功恶意文件。</p><p>&nbsp; 进一步研究发现，通过构造一个特定的INF，让其修改Runonce注册表，重新启动即会加载同目录下面的目标文件，造成远程任意代码执行。由于漏洞的基本攻击原理是触发右键菜单的默认关联项，因此，攻击者可以不局限于通过INF来发起攻击，比如利用控制面板程序CPL或者其他可以右键操作能执行的都可以发起攻击，更高级的攻击则可以实现无需重启实时高权限执行代码的功能。CNVD对该漏洞的综合评级为“高危”。</p><p>&nbsp; 目前，互联网上披露的攻击分析一般是通过各种使用OLE组件的文档发起攻击。例如：通过PowerPoint文件，特别是.pps和.ppsx这些可以自动播放的文件。用户打开攻击者精心构造的包含特定OLE \r\n对象的文件，即可获得与当前登录用户相同的操作系统权限。根据国内外安全研究机构的分析和监测情况，该漏洞已经在互联网上一些APT攻击被利用。</p><p><strong>二、漏洞影响范围</strong></p><p>&nbsp;此漏洞影响除XP外的所有Windows系统，其中包括目前应用量最广的服务器系统Windows Server2008和Windows \r\nServer2012。部分受影响的软件及系统如下所示：&nbsp;</p><p>Microsoft Windows Vista</p><p>Microsoft Windows Server 2008</p><p>Microsoft Windows 7</p><p>Microsoft Windows Server 2008 R2</p><p>Microsoft Windows 8</p><p>Microsoft Windows 8.1</p><p>Microsoft Windows RT</p><p>Microsoft Windows RT 8.1</p><p>&nbsp;此外，根据已经发现的恶意代码攻击情况看，该漏洞已经在8月份已经被黑客地下产业利用。</p><p><strong>三、漏洞处置建议</strong></p><p>&nbsp;微软公司发布了MS14-060公告，提供的漏洞安全补丁，建议受影响的用户及时升级最新的安全补丁.&nbsp;</p><p>&nbsp;如果用户不能及时安装补丁，建议采用如下防护措施:&nbsp;</p><p>1、禁用Webclient服务即禁用WEBDAV访问，但这会导致所有依赖WEBDAV的功能失效。禁用方法如下：</p><p>&nbsp; 1）单击“开始”，单击“运行”（在Windows 8 和 8.1上按 Windows 徽标键 + S 打开搜索），</p><p>&nbsp; 2）键入“Services.msc”，然后单击“确定”。</p><p>&nbsp; 3）右键单击“WebClient”，然后选择“属性”。</p><p>&nbsp; 4）将“启动类型”更改为“已禁用”。如果服务正在运行，请单击“停止”。单击“确定”，然后退出服务管理控制台。</p><p>2、同时在边界网关上阻止外部IP对 TCP 端口 139 和 445的访问。</p><p>3、建议不要打开不明来源的邮件附件和文档。</p><p>注：CNVD成员单位绿盟科技、安天公司提供了漏洞分析文档和研判支持。</p></ul><p><br/></p>', '402881e44695183a01469522f7d20019', '5a4355374c142ed1014c14310e790001', 'xjwlaq', '5a43553b4a90dbfa014a90e9e2050016', '2015-03-15 00:07:39', '61');
...
-- ----------------------------
INSERT INTO `weixin_cms_menu` VALUES ('402881e44695183a01469522f7d20019', '5a4355374c142ed1014c14310e790001', 'admin', '2014-06-13 20:10:35', '管理员', 'upload/files/201406132357343zuaHgX4.jpg', '537f1f63dd1c9.jpg', '漏洞公告', '01', '', '1');
INSERT INTO `weixin_cms_menu` VALUES ('402881e44695183a014695234880001c', '5a4355374c142ed1014c14310e790001', 'admin', '2014-06-13 20:10:56', '管理员', 'upload/files/20140613235754hLRC87rF.jpg', '537f1f86602b3.jpg', '恶意代码', '01', '', '2');
INSERT INTO `weixin_cms_menu` VALUES ('402881e44695183a01469523f03a001f', '5a4355374c142ed1014c14310e790001', 'admin', '2014-06-13 20:11:39', '管理员', 'upload/files/201406132358039IpFSyet.jpg', '537f1f74d031c.jpg', '其他威胁', '01', '', '3');
INSERT INTO `weixin_cms_menu` VALUES ('402881e44695183a0146952426ce0022', '5a4355374c142ed1014c14310e790001', 'admin', '2014-06-13 20:11:53', '管理员', 'upload/files/20140613235830M96wj4Lr.jpg', '537f1f98d6f42.jpg', '国内要闻', '01', '', '4');
INSERT INTO `weixin_cms_menu` VALUES ('402881e446955c7c014695a72a610029', '5a4355374c142ed1014c14310e790001', 'admin', '2014-06-13 22:34:59', '管理员', 'upload/files/20140613235852gBTueAWO.jpg', '537f1faf595dd.jpg', '国际新闻', '01', '', '5');
INSERT INTO `weixin_cms_menu` VALUES ('402881e446955c7c014695a774f9002c', '5a4355374c142ed1014c14310e790001', 'admin', '2014-06-13 22:35:18', '管理员', 'upload/files/20140613235911chsAs0Md.jpg', '537f1ca3cd562.jpg', '安全指数', '01', '', '6');
INSERT INTO `weixin_cms_menu` VALUES ('402881e446955c7c014695a7bc45002f', '5a4355374c142ed1014c14310e790001', 'admin', '2014-06-13 22:35:36', '管理员', 'upload/files/20140613235918OA8vt546.jpg', '537f1cb75c597.jpg', '安全报告', '01', '', '7');
INSERT INTO `weixin_cms_menu` VALUES ('402881e446955c7c014695a7f08b0032', '5a4355374c142ed1014c14310e790001', 'admin', '2014-06-13 22:35:50', '管理员', 'upload/files/20140613235932htqZFtCs.jpg', '537f1fc8d750b.jpg', '态势动态', '01', '', '8');
INSERT INTO `weixin_cms_menu` VALUES ('402881e446955c7c014695a836da0035', '5a4355374c142ed1014c14310e790001', 'admin', '2014-06-13 22:36:08', '管理员', 'upload/files/20140613235949UuUHp1Bs.jpg', 'jeecg_scott.jpg', '安全科普', '01', '', '9');
...
-- ----------------------------
INSERT INTO `weixin_cms_site` VALUES ('402889f647470484014747094556000a', '5a4355374c142ed1014c14310e790001', '12345676', '2014-07-18 09:14:55', 'admin', 'upload/files/201503161814164xE6MnNh.jpg', '新疆网络安全信息平台', '', '2015-03-16 18:14:23', 'xjwlaq');
...
-- ----------------------------
INSERT INTO `weixin_expandconfig` VALUES ('402881e44667912a0146679390450001', '402881e8461795c201461795c2e90000', 'weixin.idea.extend.function.impl.FanYiKeyService', '翻译', '翻译1233', '翻译');
INSERT INTO `weixin_expandconfig` VALUES ('402881e44667912a014667947a3a0003', '402881e8461795c201461795c2e90000', 'weixin.idea.extend.function.impl.TianQiKeyService', '天气预报', '天气312', '天气预报');
INSERT INTO `weixin_expandconfig` VALUES ('402881e446950f86014695120f810001', '402881e8461795c201461795c2e90000', 'weixin.idea.extend.function.impl.DaZhuanPanService', '大转盘', '大转盘312', '大转盘');
INSERT INTO `weixin_expandconfig` VALUES ('402881e446950f8601469513ec670003', '402881e8461795c201461795c2e90000', 'weixin.idea.extend.function.impl.CmsService', 'CMS', 'CMS,cms,CMs,cMs,CmS,Cms', 'CMS,cms,CMs,cMs,CmS,Cms');
INSERT INTO `weixin_expandconfig` VALUES ('402881e4469ffe7a0146a000090d0001', '402881e8461795c201461795c2e90000', 'weixin.idea.extend.function.impl.GuagualeService', '刮刮乐', '刮刮乐12', '刮刮乐');
INSERT INTO `weixin_expandconfig` VALUES ('402881e747baf1ea0147bb79d2330007', '402881e8461795c201461795c2e90000', 'weixin.idea.extend.function.impl.WeixinPhotoService', '微相册', '微相册,相册12', '微相册');
INSERT INTO `weixin_expandconfig` VALUES ('402881e9470273d2014702a94a1b001d', '402881e8461795c201461795c2e90000', 'weixin.idea.extend.function.impl.WeixinShopService', '微信商城', '微商城,商城12', '微商城');
INSERT INTO `weixin_expandconfig` VALUES ('5a4355374a6d6f41014a6dccf1e5000d', '402881e8461795c201461795c2e90000', 'weixin.idea.extend.function.impl.queryvirusService', '病毒查询', 'cx,CX,cX,Cx', '病毒查询');
...
-- ----------------------------
INSERT INTO `weixin_menuentity` VALUES ('5a4355374c1dfa97014c1e1d15b20027', '1', 'text', '木马查询', '11', '5a4355374c1dfa97014c1e12377f0010', 'click', '', 'f39c71ca47ed05080147edaed9070018', '5a4355374c142ed1014c14310e790001');
INSERT INTO `weixin_menuentity` VALUES ('5a4355374c1dfa97014c1e1dfc3c002a', '1111', 'text', '蠕虫查询', '111', '5a4355374c1dfa97014c1e131cd00011', 'click', '', 'f39c71ca47ed05080147edaed9070018', '5a4355374c142ed1014c14310e790001');
INSERT INTO `weixin_menuentity` VALUES ('5a4355374c1dfa97014c1e1f767b002d', '123', 'text', ' 手机查询', '123', '5a4355374c1dfa97014c1e13dd900012', 'click', '', null, '5a4355374c142ed1014c14310e790001');
INSERT INTO `weixin_menuentity` VALUES ('5a4355374c1dfa97014c1e24b5200030', '1231', 'text', '帮助', '2', '5a4355374c1dfa97014c1e247326002f', 'click', '', 'f39c71ca48169da0014816b2f04c0001', '5a4355374c142ed1014c14310e790001');
INSERT INTO `weixin_menuentity` VALUES ('f39c71ca47ed05080147edaed9070018', 'fw', 'text', 'IP查询', '1', '4028d8814734ee0d0147356b4c730010', 'click', '', null, '5a4355374c142ed1014c14310e790001');
INSERT INTO `weixin_menuentity` VALUES ('f39c71ca48169da0014816b2f04c0001', 'mine', 'news', '更多', '3', 'f39c71ca481090c2014810ec18550038', 'click', '', null, '5a4355374c142ed1014c14310e790001');
INSERT INTO `weixin_menuentity` VALUES ('f39c71ca48169da0014816b473150003', 'changeSchool', 'expand', '微网站', '1', '402881e446950f8601469513ec670003', 'click', '', 'f39c71ca48169da0014816b2f04c0001', '5a4355374c142ed1014c14310e790001');
...
INSERT INTO `weixin_newsitem` VALUES ('5a4355374c1dfa97014c1e14fe2d0015', null, 'admin', '', '', 'upload/files/20150315233651m3Y02hdd.jpg', '1', '欢迎关注', '5a4355374c1dfa97014c1e14230a0013', 'http://www.baidu.com', '2015-03-15', '5a4355374c142ed1014c14310e790001');
...
INSERT INTO `weixin_newstemplate` VALUES ('5a4355374c1dfa97014c1e14230a0013', '2015-03-15 23:36:18', '关注图文', 'cl', '5a4355374c142ed1014c14310e790001');
...
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a7049cf2e0000', 'cx', '2014-12-22 12:38:13', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095517045249247456', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a704d4b840001', 'cx', '2014-12-22 12:42:01', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095518028796758567', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a705006150002', 'cx', '2014-12-22 12:45:00', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095518789005970216', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a705030900003', 'com', '2014-12-22 12:45:11', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095518844840545080', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a705128460004', 'cxmm127.0.0.1', '2014-12-22 12:46:14', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095519111128517505', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a7052b2cb0006', 'cx', '2014-12-22 12:47:55', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095519549215181819', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a7052e1d40007', 'cxmm127.0.0.1', '2014-12-22 12:48:07', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095519600754789394', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a7054ddc30009', 'cxmm127.0.0.1', '2014-12-22 12:50:17', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095520154805570712', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a705509df000b', 'cxmm127.0.0.1', '2014-12-22 12:50:28', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095520206345178290', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a705559cc000d', 'cx127.0.0.1', '2014-12-22 12:50:49', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095520296539491519', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a70566c60000e', 'cx127.0.0.1', '2014-12-22 12:51:59', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095520592892235059', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a70587328000f', 'cx127.0.0.1', '2014-12-22 12:54:12', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095521164122885701', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a7058fb090010', 'cx', '2014-12-22 12:54:47', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095521318741708418', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a705924a00011', 'cxmm127.0.0.1', '2014-12-22 12:54:57', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095521361691381407', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a70594e430013', 'cxmm127.0.0.1', '2014-12-22 12:55:08', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095521408936021690', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a70599d0f0015', 'cxmm127.0.0.1', '2014-12-22 12:55:28', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095521494835367639', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a705ec8aa0017', 'cxrc127.0.0.1', '2014-12-22 13:01:07', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095522946534314136', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a7060a2840019', 'cxmm127.0.0.1', '2014-12-22 13:03:08', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095523466225357112', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a7067244f001b', 'cxmm', '2014-12-22 13:10:15', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095525300176393126', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a7067586b001c', 'cxmm127.0.0.1', '2014-12-22 13:10:28', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095525360305935289', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a7067f0af001d', 'cxmm127.0.0.1', '2014-12-22 13:11:07', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095525527809659873', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a7068a16b001e', 'cxmm127.0.0.7', '2014-12-22 13:11:52', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095525721083188252', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a706a7e98001f', 'cxrc', '2014-12-22 13:13:55', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095526240774231241', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a706aae010020', 'cxrc127.0.0.1', '2014-12-22 13:14:07', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095526300903773404', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a706c222f0021', 'cxrc127.0.0.1', '2014-12-22 13:15:42', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095526700335732038', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a706cdcdd0023', 'cxrc127.0.0.1', '2014-12-22 13:16:30', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095526915084096893', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a706dc0710025', 'cxrc127.0.0.1', '2014-12-22 13:17:28', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095527164192200162', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a706ddcc70027', 'cxrc127.0.0.1', '2014-12-22 13:17:35', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095527164192200162', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a706edfbb0028', 'cxrc127.0.0.1', '2014-12-22 13:18:42', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095527473429845549', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a708e42b40029', 'cx', '2014-12-22 13:52:59', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095536308177576111', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a708f019a002a', 'cxmm127.0.0.1', '2014-12-22 13:53:47', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095536522925940981', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a708f3066002b', 'cxrc1270.0.1', '2014-12-22 13:53:59', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095536574465548560', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a70915b73002c', '哦', '2014-12-22 13:56:22', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095537180055937506', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a7091a153002d', '查询病毒', '2014-12-22 13:56:39', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095537261660316181', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a7091bc16002e', 'cx', '2014-12-22 13:56:46', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095537291725087268', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a7092a8f3002f', 'cxmm122222', '2014-12-22 13:57:47', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095537553718092388', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a7092d1360030', 'cxsaaa', '2014-12-22 13:57:57', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095537596667765370', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a7092f0730031', 'cxdfghh', '2014-12-22 13:58:05', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095537631027503748', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a709304270032', 'cxmm', '2014-12-22 13:58:10', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095537652502340237', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a704938014a709367d20033', 'cxmm', '2014-12-22 13:58:36', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095537764171489963', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a712b16014a712cd8130000', 'cxnnnn', '2014-12-22 16:46:11', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095580937182767162', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a712b16014a712d36ba0001', 'cxmm127.0.0.1', '2014-12-22 16:46:36', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095581053146884207', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a712b16014a712e3eaa0002', 'cxmm', '2014-12-22 16:47:43', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095581340909693169', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a712b16014a712e4f090003', 'cxmm', '2014-12-22 16:47:47', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095581340909693169', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a712b16014a712ecf340004', 'cxbb', '2014-12-22 16:48:20', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095581504118450466', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a712b16014a7130d0840005', 'cxbb', '2014-12-22 16:50:32', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095582062464199198', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a712b16014a7130f4090006', 'cxmmqq', '2014-12-22 16:50:41', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095582109708839482', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a712b16014a7131d1ac0007', 'cxmm', '2014-12-22 16:51:38', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095582350227008151', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374a712b16014a71320c290008', 'cxtel123456', '2014-12-22 16:51:53', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095582414651517617', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c142ed1014c14427dc10013', 'Cx', '2015-03-14 01:50:44', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6125778985395489199', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c142ed1014c1443a6f30016', 'cms', '2015-03-14 01:52:00', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6125779316107970999', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c142ed1014c1443d4a60017', 'cms', '2015-03-14 01:52:11', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6125779363352611257', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c142ed1014c144b30ab001b', 'Cms', '2015-03-14 02:00:14', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6125781437821815277', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c142ed1014c144b93a2001d', 'c ms', '2015-03-14 02:00:39', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6125781545195997680', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c142ed1014c144ba4ed001e', 'Cms', '2015-03-14 02:00:44', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6125781562375866866', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c142ed1014c144c7041001f', 'Cms', '2015-03-14 02:01:36', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6125781785714166264', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c142ed1014c144cbf700020', '天气312', '2015-03-14 02:01:56', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6125781875908479484', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c144e66014c144e93740000', 'Cms', '2015-03-14 02:03:56', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6125782387009587731', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c17013f014c171e1058000f', 'Cms', '2015-03-14 15:09:48', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6125984907602544861', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c17013f014c171e76990010', 'cms', '2015-03-14 15:10:14', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6125985019271694652', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c1720a1014c17211dcf0000', 'cms', '2015-03-14 15:13:08', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6125985766596004776', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c1720a1014c1724aef90001', 'cms', '2015-03-14 15:17:02', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6125986771618352791', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c1720a1014c174c89d50003', 'cms', '2015-03-14 16:00:34', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6125997990072938740', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c1720a1014c176dfb06000b', 'Cms', '2015-03-14 16:37:05', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6126007387461389767', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c1720a1014c176e220e000c', 'cms', '2015-03-14 16:37:15', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6126007447590931956', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c1720a1014c176faec6000d', 'cms', '2015-03-14 16:38:57', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6126007881382629162', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c1720a1014c177094b2000e', 'cms', '2015-03-14 16:39:56', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6126008134785699793', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c1720a1014c177cc0270014', 'Cxmm12', '2015-03-14 16:53:13', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6126011557874637377', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c1720a1014c177cf4e70015', 'Cxmm123', '2015-03-14 16:53:27', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6126011618004179560', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c1720a1014c177d14510016', 'cx', '2015-03-14 16:53:35', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6126011652363917942', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c1720a1014c177d88ad0017', 'cxmm127.', '2015-03-14 16:54:05', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6126011781212936931', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c1720a1014c178f7bf4001f', 'cx', '2015-03-14 17:13:41', 'oM0bRt0TgznDg32iF-FPq5qBYh54', '6126016832094480886', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c1dfa97014c1e0d5e160001', 'Cx mm', '2015-03-15 23:28:54', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6126484614162744745', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c1dfa97014c1e0d97200002', 'Cxmm', '2015-03-15 23:29:09', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6126484678587254202', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c1dfa97014c1e0da3dd0003', 'Cx', '2015-03-15 23:29:12', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6126484678587254201', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c1dfa97014c1e105e99000b', 'Cx', '2015-03-15 23:32:11', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6126485460271302223', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c1dfa97014c1e107b0f000c', 'Cxmm', '2015-03-15 23:32:18', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6126485494631040597', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c1dfa97014c206a670a003e', '广告', '2015-03-16 10:29:46', 'oM0bRt91tjPNVXf3GwE8DIYD4McQ', '6126654918205976812', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c1dfa97014c209fd8820055', '天天', '2015-03-16 11:28:08', 'oM0bRt91tjPNVXf3GwE8DIYD4McQ', '6126669959181450662', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c2667a9014c2719bd440002', 'Cx', '2015-03-17 17:39:00', 'oM0bRt9SjvTV7cdKoaJfTAsc2MFY', '6127136620263185700', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c2667a9014c2aabc9090003', 'Cx', '2015-03-18 10:17:23', 'oM0bRt9SjvTV7cdKoaJfTAsc2MFY', '6127393901689160038', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a4355374c2667a9014c2b0709f20004', '好', '2015-03-18 11:57:03', 'oM0bRt4vaf4bBctyrrUU_1JrVwoI', '6127419585593595653', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a43553b4a7218e2014a7248b3960020', 'cx', '2014-12-22 21:56:14', 'oM0bRt9UQ0ooPR57oEvCb9TOM6c4', '6095661227301431163', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a43553b4a7218e2014a724910b50021', 'cxmm', '2014-12-22 21:56:38', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095661330380646294', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a43553b4a7218e2014a724939ea0022', 'cxtel7268469', '2014-12-22 21:56:49', 'oM0bRt9UQ0ooPR57oEvCb9TOM6c4', '6095661369035351976', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a43553b4a7218e2014a72495c050024', 'cxtel', '2014-12-22 21:56:57', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095661411985024949', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a43553b4a7218e2014a724a01fd0026', '03', '2014-12-22 21:57:40', 'oM0bRt9UQ0ooPR57oEvCb9TOM6c4', '6095661596668618732', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a43553b4a7218e2014a724a373c0027', '大转盘', '2014-12-22 21:57:54', 'oM0bRt9UQ0ooPR57oEvCb9TOM6c4', '6095661652503193604', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
INSERT INTO `weixin_receivetext` VALUES ('5a43553b4a7218e2014a724a3b350028', 'cxmm127.0.0.1', '2014-12-22 21:57:55', 'oM0bRt6ioIpPDZ0Gf5XdqSBnUew0', '6095661656798160902', 'text', null, '0', 'gh_985d88f8eb37', 'gh_985d88f8eb37');
...
INSERT INTO `weixin_subscribe` VALUES ('5a4355374c1dfa97014c1e153ed90017', '5a4355374c142ed1014c14310e790001', '2015-03-15 23:37:31', 'news', '5a4355374c1dfa97014c1e14230a0013', '关注图文');
...
-- ----------------------------
INSERT INTO `weixin_texttemplate` VALUES ('5a4355374c1dfa97014c1e12377f0010', '2015-03-15 23:34:12', '请回复关键字cxmm+ip\r\n如：cmm127.0.0.1', '木马查询', '5a4355374c142ed1014c14310e790001');
INSERT INTO `weixin_texttemplate` VALUES ('5a4355374c1dfa97014c1e131cd00011', '2015-03-15 23:35:11', '请回复所需关键字：cxrc+ip\r\n如：cxrc127.0.01', '蠕虫查询', '5a4355374c142ed1014c14310e790001');
INSERT INTO `weixin_texttemplate` VALUES ('5a4355374c1dfa97014c1e13dd900012', '2015-03-15 23:36:00', '请回复所需关键字：cxtel+手机号\r\n如：cxtel13212331233', '电话查询', '5a4355374c142ed1014c14310e790001');
INSERT INTO `weixin_texttemplate` VALUES ('5a4355374c1dfa97014c1e247326002f', '2015-03-15 23:54:07', '请回复所需关键字:\r\n查询木马请回复：cxmm+ip\r\n如：cxmm127.0.0.1\r\n查询蠕虫请回复：cxrc+ip\r\n如:cxrc127.0.0.1\r\n查询手机病毒请回复：cxtel+手机号\r\n如:cxtel15887654321', '帮助信息', '5a4355374c142ed1014c14310e790001');
INSERT INTO `weixin_texttemplate` VALUES ('f7a8a3a946e55a940146e5c317f6005f', '2014-06-29 11:55:06', '欢迎关注新疆网络安全预警平台！', '欢迎关注语', '402881e8461795c201461795c2e90000');
