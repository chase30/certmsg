...
public String getStylePath()
  {
    WeixinCmsSiteEntity weixinCmsSiteEntity = findUniqueByProperty(WeixinCmsSiteEntity.class, "accountid", ResourceUtil.getShangJiaAccountId());
    ...
    if (weixinCmsSiteEntity != null) {
      if (weixinCmsSiteEntity.getSiteTemplateStyle() != null) {
        weixinCmsStyleEntity = get(WeixinCmsStyleEntity.class, weixinCmsSiteEntity.getSiteTemplateStyle());
      }
